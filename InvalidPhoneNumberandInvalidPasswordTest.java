...
import java.net.URL;
public class InvalidPhoneNumberandInvalidPasswordTest {
  ...
  @Test
  public void invalidPhoneNumberandInvalidPassword() {
    driver.get("https://www.konga.com/");
    driver.manage().window().setSize(new Dimension(1382, 744));
    driver.findElement(By.linkText("Login / Signup")).click();
    driver.findElement(By.id("username")).click();
    driver.findElement(By.id("username")).sendKeys("08060558449");
    driver.findElement(By.id("password")).click();
    driver.findElement(By.id("password")).sendKeys("myself");
